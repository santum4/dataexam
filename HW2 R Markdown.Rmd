...
![Sketch with the five curves](C:/Local/Local Disk/UTSA PhD/STA 6923 Introduction to Statistical Learning_Fall_2021/Homework/HW2/DrawProblem3.png)
...
```{r Boston1a,  echo=TRUE, warning=FALSE, message=FALSE}
library(MASS)
head(Boston)
dim(Boston)
```
...
```{r Boston1b,  echo=TRUE, warning=FALSE, message=FALSE}
str(Boston)
...
```{r Boston1c,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1d1,  echo=TRUE, warning=FALSE, message=FALSE}
summary(Boston$crim)
summary(Boston$tax)
...
```{r Boston1d3,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1d4,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1d5,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1d6,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1e,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1f,  echo=TRUE, warning=FALSE, message=FALSE}
summary(Boston$ptratio)
```
...
```{r Boston1g1,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1g2,  echo=TRUE, warning=FALSE, message=FALSE}
summary(Boston)
```
...
```{r Boston1h1,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1h2,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r Boston1h3,  echo=TRUE, warning=FALSE, message=FALSE}
summary(rm_over_8)  
```
...
```{r notfrombook1a,  echo=TRUE, warning=FALSE, message=FALSE}
quadfn1 <- function(x){
  y = 2 + 3*x*x -x
} 
...
```{r notfrombook1b,  echo=TRUE, warning=FALSE, message=FALSE}
library(reshape2)
...
```{r notfrombook2,  echo=TRUE, warning=FALSE, message=FALSE}
set.seed(123)
df = data.frame(x1 = rnorm(10), x2 = rpois(10,3), x3 = runif(10,-1,1), x4 = rgamma(10,2,3))
df
```
...
```{r notfrombook2a,  echo=TRUE, warning=FALSE, message=FALSE}
apply(df,2,mean)
```

b) Add another column, named c5, which is 1 for all x1>=0 and 0 otherwise.

```{r notfrombook2b,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook2c,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3a,  echo=TRUE, warning=FALSE, message=FALSE}
autompg <- read_csv("C:/Local/Local Disk/UTSA PhD/STA 6923 Introduction to Statistical Learning_Fall_2021/Homework/HW2/auto-mpg.csv")
head(autompg)
```
...
```{r notfrombook3b,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3c,  echo=TRUE, warning=FALSE, message=FALSE}
library(dplyr)
autompg 
...
```{r notfrombook3d,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3e,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3f,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3g,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3h,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3i,  echo=TRUE, warning=FALSE, message=FALSE}
...
```{r notfrombook3j,  echo=TRUE, warning=FALSE, message=FALSE}
